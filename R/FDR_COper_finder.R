...
#this function is meant for p-score files that were calculated with RE sites and bp

FDR_COper_finder <- function(filename_pscore, filename_raw, vp.chrom, vp.pos, erase, wind, REs, cyc, perc, fdr, rem=0.1) 
{
