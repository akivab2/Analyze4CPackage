...
ChIPSeqCorContacts <- function(Experiments_4C,rearranged_rawData,ChIPseqVScontacts_correlation_plots)
{
	...
	while(files_flag == 0)
	{
		...
		#removing the translocated areas from 'ps_afterCO' and 'peaks_afterCO' if they were switched
		...
		{
			system("bedtools intersect -a ~/Analyze4C/temp/ps_bed.bed -b ~/Analyze4C/temp/peaks.bed -wo > ~/Analyze4C/temp/intersected.bed")			
